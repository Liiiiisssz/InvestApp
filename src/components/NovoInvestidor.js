    ...
    return (
        <>
            <button
                ...
                className="bg-green-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors"
            >
                + Novo Investidor
            </button>
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-md p-6 overflow-y-auto max-h-[90vh]">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <div className="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-200">
                                ...
                                <button 
                                    type="submit" 
                                    className="px-4 py-2 text-white bg-green-600 hover:bg-blue-700 rounded-lg transition-colors shadow-sm"
                                >
                                    Salvar Investidor
                                </button>
                            </div>
